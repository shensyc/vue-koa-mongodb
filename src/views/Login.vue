        ...
        <div class="login-area">
            ...
            <div class="login-form">
                <div class="login-form-header">
                    ...
                    <div class="pdb10">Enter your username and password to login</div>
                </div>
                <div class="login-form-body">
                    <el-form ref="loginForm" :model="loginForm" label-width="80px" class="form-container" :rules="loginRules">
                        <el-form-item prop="user_id">
                            <el-input placeholder="用户名" prefix-icon="el-icon-user" v-model="loginForm.user_id"></el-input>
                        </el-form-item>
                        <el-form-item prop="user_pwd">
                            <el-input placeholder="密码" prefix-icon="el-icon-lock" v-model="loginForm.user_pwd"></el-input>
                        </el-form-item>
                        ...
                        <el-button type="danager" class="w100" @click="login('loginForm')" :loading="loginStatus">登陆</el-button>
